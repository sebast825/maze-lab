...
export const MazeSizeSpecs: Record<MazeSizeSpecKey, MazeSizeSpecValues> = {
  "10x10": {
    ...
    shortestPathDecisionAvg: { p5: 0.12, p95: 0.58 },
  ...
  "20x20": {
    ...
    shortestPathDecisionAvg: { p5: 0.1, p95: 0.58 },
  ...
  "30x30": {
    ...
    shortestPathDecisionAvg: { p5: 0.1, p95: 0.6 },
  ...
  "40x40": {
    ...
    shortestPathDecisionAvg: { p5: 0.1, p95: 0.59 },
  ...
  "60x60": {
    ...
    shortestPathDecisionAvg: { p5: 0.08, p95: 0.59 },
